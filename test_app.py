...
class AgencyTestCase(unittest.TestCase):
    ...
    def test_405_if_movie_creation_not_allowed(self):
        # Store the response in the 'res' variable
        res = self.client().post('/movies/1000', headers=self.executive_producer, json=self.new_movie)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_422_if_movie_data_is_missing(self):
        ...
        res = self.client().post('/movies', headers=self.executive_producer, json=self.new_missing_movie)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_405_if_actor_creation_not_allowed(self):
        # Store the response in the 'res' variable
        res = self.client().post('/actors/1000', headers=self.casting_director, json=self.new_actor)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_403_if_actor_creation_not_authorized(self):
        # Store the response in the 'res' variable
        res = self.client().post('/actors/1000', headers=self.casting_assistant, json=self.new_actor)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_422_if_actor_data_is_missing(self):
        # Store the response in the 'res' variable (send json with some empty fields)
        res = self.client().post('/actors', headers=self.casting_director, json=self.new_missing_actor)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_update_movie(self):
        # Store the response in the 'res' variable
        res = self.client().patch('/movies/1', headers=self.executive_producer, json=self.update_movie)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_405_if_movie_update_not_allowed(self):
        # Store the response in the 'res' variable
        res = self.client().patch('/movies', headers=self.executive_producer, json=self.update_movie)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_update_actor(self):
        # Store the response in the 'res' variable
        res = self.client().patch('/actors/1', headers=self.casting_director, json=self.update_actor)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
    ...
    def test_405_if_actor_update_not_allowed(self):
        # Store the response in the 'res' variable
        res = self.client().patch('/actors', headers=self.casting_director, json=self.update_actor)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
